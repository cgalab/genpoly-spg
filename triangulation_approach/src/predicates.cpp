...
/*                                                                           */
/* modified by Martin Held on 02-Dec-2008 in order to make it compile        */
/* without errors.                                                           */
/*                                                                           */
...
/*
void expansion_print(int elen, double *e)
{
  int i;
...
REAL orient2dfast(point pa, point pb, point pc)
{
...
REAL orient2dexact(point pa, point pb, point pc)
{
...
/*
double orient2dslow(predicatesdef *pred, point pa, point pb, point pc)
{
  ...
  Two_Two_Product(pred, acx, acxtail, bcy, bcytail,
                  axby7, axby[6], axby[5], axby[4],
                  axby[3], axby[2], axby[1], axby[0]);
  axby[7] = axby7;
  negate = -acy;
  negatetail = -acytail;
  Two_Two_Product(pred, bcx, bcxtail, negate, negatetail,
...
REAL orient2dadapt(point pa, point pb, point pc, REAL detsum)
{
...
double orient3dexact(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd)
{
  ...
  Two_Product(pred, pa[0], pb[1], axby1, axby0);
  Two_Product(pred, pb[0], pa[1], bxay1, bxay0);
  Two_Two_Diff(axby1, axby0, bxay1, bxay0, ab[3], ab[2], ab[1], ab[0]);

  Two_Product(pred, pb[0], pc[1], bxcy1, bxcy0);
  Two_Product(pred, pc[0], pb[1], cxby1, cxby0);
  Two_Two_Diff(bxcy1, bxcy0, cxby1, cxby0, bc[3], bc[2], bc[1], bc[0]);

  Two_Product(pred, pc[0], pd[1], cxdy1, cxdy0);
  Two_Product(pred, pd[0], pc[1], dxcy1, dxcy0);
  Two_Two_Diff(cxdy1, cxdy0, dxcy1, dxcy0, cd[3], cd[2], cd[1], cd[0]);

  Two_Product(pred, pd[0], pa[1], dxay1, dxay0);
  Two_Product(pred, pa[0], pd[1], axdy1, axdy0);
  Two_Two_Diff(dxay1, dxay0, axdy1, axdy0, da[3], da[2], da[1], da[0]);

  Two_Product(pred, pa[0], pc[1], axcy1, axcy0);
  Two_Product(pred, pc[0], pa[1], cxay1, cxay0);
  Two_Two_Diff(axcy1, axcy0, cxay1, cxay0, ac[3], ac[2], ac[1], ac[0]);

  Two_Product(pred, pb[0], pd[1], bxdy1, bxdy0);
  Two_Product(pred, pd[0], pb[1], dxby1, dxby0);
...
double orient3dslow(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd)
{
  ...
  Two_Two_Product(pred, adx, adxtail, bdy, bdytail,
                  axby7, axby[6], axby[5], axby[4],
                  axby[3], axby[2], axby[1], axby[0]);
  axby[7] = axby7;
  negate = -ady;
  negatetail = -adytail;
  Two_Two_Product(pred, bdx, bdxtail, negate, negatetail,
                  bxay7, bxay[6], bxay[5], bxay[4],
                  bxay[3], bxay[2], bxay[1], bxay[0]);
  bxay[7] = bxay7;
  Two_Two_Product(pred, bdx, bdxtail, cdy, cdytail,
                  bxcy7, bxcy[6], bxcy[5], bxcy[4],
                  bxcy[3], bxcy[2], bxcy[1], bxcy[0]);
  bxcy[7] = bxcy7;
  negate = -bdy;
  negatetail = -bdytail;
  Two_Two_Product(pred, cdx, cdxtail, negate, negatetail,
                  cxby7, cxby[6], cxby[5], cxby[4],
                  cxby[3], cxby[2], cxby[1], cxby[0]);
  cxby[7] = cxby7;
  Two_Two_Product(pred, cdx, cdxtail, ady, adytail,
                  cxay7, cxay[6], cxay[5], cxay[4],
                  cxay[3], cxay[2], cxay[1], cxay[0]);
  cxay[7] = cxay7;
  negate = -cdy;
  negatetail = -cdytail;
  Two_Two_Product(pred, adx, adxtail, negate, negatetail,
...
double orient3dadapt(predicatesdef *pred,
                     ...
                     double permanent)
{
  ...
  Two_Product(pred, bdx, cdy, bdxcdy1, bdxcdy0);
  Two_Product(pred, cdx, bdy, cdxbdy1, cdxbdy0);
  Two_Two_Diff(bdxcdy1, bdxcdy0, cdxbdy1, cdxbdy0, bc3, bc[2], bc[1], bc[0]);
  bc[3] = bc3;
  alen = scale_expansion_zeroelim(4, bc, adz, adet);

  Two_Product(pred, cdx, ady, cdxady1, cdxady0);
  Two_Product(pred, adx, cdy, adxcdy1, adxcdy0);
  Two_Two_Diff(cdxady1, cdxady0, adxcdy1, adxcdy0, ca3, ca[2], ca[1], ca[0]);
  ca[3] = ca3;
  blen = scale_expansion_zeroelim(4, ca, bdz, bdet);

  Two_Product(pred, adx, bdy, adxbdy1, adxbdy0);
  Two_Product(pred, bdx, ady, bdxady1, bdxady0);
  ...
  if (adxtail == 0.0) {
    if (adytail == 0.0) {
      ...
      negate = -adytail;
      Two_Product(pred, negate, bdx, at_blarge, at_b[0]);
      at_b[1] = at_blarge;
      at_blen = 2;
      Two_Product(pred, adytail, cdx, at_clarge, at_c[0]);
      at_c[1] = at_clarge;
      at_clen = 2;
    }
  } else {
    if (adytail == 0.0) {
      Two_Product(pred, adxtail, bdy, at_blarge, at_b[0]);
      at_b[1] = at_blarge;
      at_blen = 2;
      negate = -adxtail;
      Two_Product(pred, negate, cdy, at_clarge, at_c[0]);
      at_c[1] = at_clarge;
      at_clen = 2;
    } else {
      Two_Product(pred, adxtail, bdy, adxt_bdy1, adxt_bdy0);
      Two_Product(pred, adytail, bdx, adyt_bdx1, adyt_bdx0);
      Two_Two_Diff(adxt_bdy1, adxt_bdy0, adyt_bdx1, adyt_bdx0,
                   at_blarge, at_b[2], at_b[1], at_b[0]);
      at_b[3] = at_blarge;
      at_blen = 4;
      Two_Product(pred, adytail, cdx, adyt_cdx1, adyt_cdx0);
      Two_Product(pred, adxtail, cdy, adxt_cdy1, adxt_cdy0);
  ...
  if (bdxtail == 0.0) {
    if (bdytail == 0.0) {
      ...
      negate = -bdytail;
      Two_Product(pred, negate, cdx, bt_clarge, bt_c[0]);
      bt_c[1] = bt_clarge;
      bt_clen = 2;
      Two_Product(pred, bdytail, adx, bt_alarge, bt_a[0]);
      bt_a[1] = bt_alarge;
      bt_alen = 2;
    }
  } else {
    if (bdytail == 0.0) {
      Two_Product(pred, bdxtail, cdy, bt_clarge, bt_c[0]);
      bt_c[1] = bt_clarge;
      bt_clen = 2;
      negate = -bdxtail;
      Two_Product(pred, negate, ady, bt_alarge, bt_a[0]);
      bt_a[1] = bt_alarge;
      bt_alen = 2;
    } else {
      Two_Product(pred, bdxtail, cdy, bdxt_cdy1, bdxt_cdy0);
      Two_Product(pred, bdytail, cdx, bdyt_cdx1, bdyt_cdx0);
      Two_Two_Diff(bdxt_cdy1, bdxt_cdy0, bdyt_cdx1, bdyt_cdx0,
                   bt_clarge, bt_c[2], bt_c[1], bt_c[0]);
      bt_c[3] = bt_clarge;
      bt_clen = 4;
      Two_Product(pred, bdytail, adx, bdyt_adx1, bdyt_adx0);
      Two_Product(pred, bdxtail, ady, bdxt_ady1, bdxt_ady0);
  ...
  if (cdxtail == 0.0) {
    if (cdytail == 0.0) {
      ...
      negate = -cdytail;
      Two_Product(pred, negate, adx, ct_alarge, ct_a[0]);
      ct_a[1] = ct_alarge;
      ct_alen = 2;
      Two_Product(pred, cdytail, bdx, ct_blarge, ct_b[0]);
      ct_b[1] = ct_blarge;
      ct_blen = 2;
    }
  } else {
    if (cdytail == 0.0) {
      Two_Product(pred, cdxtail, ady, ct_alarge, ct_a[0]);
      ct_a[1] = ct_alarge;
      ct_alen = 2;
      negate = -cdxtail;
      Two_Product(pred, negate, bdy, ct_blarge, ct_b[0]);
      ct_b[1] = ct_blarge;
      ct_blen = 2;
    } else {
      Two_Product(pred, cdxtail, ady, cdxt_ady1, cdxt_ady0);
      Two_Product(pred, cdytail, adx, cdyt_adx1, cdyt_adx0);
      Two_Two_Diff(cdxt_ady1, cdxt_ady0, cdyt_adx1, cdyt_adx0,
                   ct_alarge, ct_a[2], ct_a[1], ct_a[0]);
      ct_a[3] = ct_alarge;
      ct_alen = 4;
      Two_Product(pred, cdytail, bdx, cdyt_bdx1, cdyt_bdx0);
      Two_Product(pred, cdxtail, bdy, cdxt_bdy1, cdxt_bdy0);
  ...
  if (adxtail != 0.0) {
    if (bdytail != 0.0) {
      Two_Product(pred, adxtail, bdytail, adxt_bdyt1, adxt_bdyt0);
      Two_One_Product(pred, adxt_bdyt1, adxt_bdyt0, cdz, u3, u[2], u[1], u[0]);
      u[3] = u3;
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (cdztail != 0.0) {
        Two_One_Product(pred, adxt_bdyt1, adxt_bdyt0, cdztail, u3, u[2], u[1], u[0]);
        u[3] = u3;
        finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                finother);
        finswap = finnow; finnow = finother; finother = finswap;
    ...
    if (cdytail != 0.0) {
      negate = -adxtail;
      Two_Product(pred, negate, cdytail, adxt_cdyt1, adxt_cdyt0);
      Two_One_Product(pred, adxt_cdyt1, adxt_cdyt0, bdz, u3, u[2], u[1], u[0]);
      u[3] = u3;
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (bdztail != 0.0) {
        Two_One_Product(pred, adxt_cdyt1, adxt_cdyt0, bdztail, u3, u[2], u[1], u[0]);
        u[3] = u3;
        finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                finother);
        finswap = finnow; finnow = finother; finother = finswap;
  ...
  if (bdxtail != 0.0) {
    if (cdytail != 0.0) {
      Two_Product(pred, bdxtail, cdytail, bdxt_cdyt1, bdxt_cdyt0);
      Two_One_Product(pred, bdxt_cdyt1, bdxt_cdyt0, adz, u3, u[2], u[1], u[0]);
      u[3] = u3;
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (adztail != 0.0) {
        Two_One_Product(pred, bdxt_cdyt1, bdxt_cdyt0, adztail, u3, u[2], u[1], u[0]);
        u[3] = u3;
        finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                finother);
        finswap = finnow; finnow = finother; finother = finswap;
    ...
    if (adytail != 0.0) {
      negate = -bdxtail;
      Two_Product(pred, negate, adytail, bdxt_adyt1, bdxt_adyt0);
      Two_One_Product(pred, bdxt_adyt1, bdxt_adyt0, cdz, u3, u[2], u[1], u[0]);
      u[3] = u3;
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (cdztail != 0.0) {
        Two_One_Product(pred, bdxt_adyt1, bdxt_adyt0, cdztail, u3, u[2], u[1], u[0]);
        u[3] = u3;
        finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                finother);
        finswap = finnow; finnow = finother; finother = finswap;
  ...
  if (cdxtail != 0.0) {
    if (adytail != 0.0) {
      Two_Product(pred, cdxtail, adytail, cdxt_adyt1, cdxt_adyt0);
      Two_One_Product(pred, cdxt_adyt1, cdxt_adyt0, bdz, u3, u[2], u[1], u[0]);
      u[3] = u3;
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (bdztail != 0.0) {
        Two_One_Product(pred, cdxt_adyt1, cdxt_adyt0, bdztail, u3, u[2], u[1], u[0]);
        u[3] = u3;
        finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                finother);
        finswap = finnow; finnow = finother; finother = finswap;
    ...
    if (bdytail != 0.0) {
      negate = -cdxtail;
      Two_Product(pred, negate, bdytail, cdxt_bdyt1, cdxt_bdyt0);
      Two_One_Product(pred, cdxt_bdyt1, cdxt_bdyt0, adz, u3, u[2], u[1], u[0]);
      u[3] = u3;
      finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                              finother);
      finswap = finnow; finnow = finother; finother = finswap;
      if (adztail != 0.0) {
        Two_One_Product(pred, cdxt_bdyt1, cdxt_bdyt0, adztail, u3, u[2], u[1], u[0]);
        u[3] = u3;
        finlength = fast_expansion_sum_zeroelim(finlength, finnow, 4, u,
                                                finother);
        finswap = finnow; finnow = finother; finother = finswap;
...
double orient3d(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd)
{
...
double incircleexact(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd)
{
  INEXACT double axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
  INEXACT double bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
  double axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
...
double incircleslow(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd)
{
...
double incircleadapt(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd,
                     double permanent)
{
  INEXACT double adx, bdx, cdx, ady, bdy, cdy;
  double det, errbound;
  ...
  if ((bdxtail != 0.0) || (bdytail != 0.0)
    ...
    Square(pred, adx, adxadx1, adxadx0);
    Square(pred, ady, adyady1, adyady0);
    Two_Two_Sum(adxadx1, adxadx0, adyady1, adyady0, aa3, aa[2], aa[1], aa[0]);
    aa[3] = aa3;
  }
  if ((cdxtail != 0.0) || (cdytail != 0.0)
      || (adxtail != 0.0) || (adytail != 0.0)) {
    Square(pred, bdx, bdxbdx1, bdxbdx0);
    Square(pred, bdy, bdybdy1, bdybdy0);
    Two_Two_Sum(bdxbdx1, bdxbdx0, bdybdy1, bdybdy0, bb3, bb[2], bb[1], bb[0]);
    bb[3] = bb3;
  }
  if ((adxtail != 0.0) || (adytail != 0.0)
      || (bdxtail != 0.0) || (bdytail != 0.0)) {
    Square(pred, cdx, cdxcdx1, cdxcdx0);
    Square(pred, cdy, cdycdy1, cdycdy0);
  ...
  if ((adxtail != 0.0) || (adytail != 0.0)) {
    if ((bdxtail != 0.0) || (bdytail != 0.0)
        || (cdxtail != 0.0) || (cdytail != 0.0)) {
      Two_Product(pred, bdxtail, cdy, ti1, ti0);
      Two_Product(pred, bdx, cdytail, tj1, tj0);
      Two_Two_Sum(ti1, ti0, tj1, tj0, u3, u[2], u[1], u[0]);
      u[3] = u3;
      negate = -bdy;
      Two_Product(pred, cdxtail, negate, ti1, ti0);
      negate = -bdytail;
      Two_Product(pred, cdx, negate, tj1, tj0);
      Two_Two_Sum(ti1, ti0, tj1, tj0, v3, v[2], v[1], v[0]);
      v[3] = v3;
      bctlen = fast_expansion_sum_zeroelim(4, u, 4, v, bct);

      Two_Product(pred, bdxtail, cdytail, ti1, ti0);
      Two_Product(pred, cdxtail, bdytail, tj1, tj0);
  ...
  if ((bdxtail != 0.0) || (bdytail != 0.0)) {
    if ((cdxtail != 0.0) || (cdytail != 0.0)
        || (adxtail != 0.0) || (adytail != 0.0)) {
      Two_Product(pred, cdxtail, ady, ti1, ti0);
      Two_Product(pred, cdx, adytail, tj1, tj0);
      Two_Two_Sum(ti1, ti0, tj1, tj0, u3, u[2], u[1], u[0]);
      u[3] = u3;
      negate = -cdy;
      Two_Product(pred, adxtail, negate, ti1, ti0);
      negate = -cdytail;
      Two_Product(pred, adx, negate, tj1, tj0);
      Two_Two_Sum(ti1, ti0, tj1, tj0, v3, v[2], v[1], v[0]);
      v[3] = v3;
      catlen = fast_expansion_sum_zeroelim(4, u, 4, v, cat);

      Two_Product(pred, cdxtail, adytail, ti1, ti0);
      Two_Product(pred, adxtail, cdytail, tj1, tj0);
  ...
  if ((cdxtail != 0.0) || (cdytail != 0.0)) {
    if ((adxtail != 0.0) || (adytail != 0.0)
        || (bdxtail != 0.0) || (bdytail != 0.0)) {
      Two_Product(pred, adxtail, bdy, ti1, ti0);
      Two_Product(pred, adx, bdytail, tj1, tj0);
      Two_Two_Sum(ti1, ti0, tj1, tj0, u3, u[2], u[1], u[0]);
      u[3] = u3;
      negate = -ady;
      Two_Product(pred, bdxtail, negate, ti1, ti0);
      negate = -adytail;
      Two_Product(pred, bdx, negate, tj1, tj0);
      Two_Two_Sum(ti1, ti0, tj1, tj0, v3, v[2], v[1], v[0]);
      v[3] = v3;
      abtlen = fast_expansion_sum_zeroelim(4, u, 4, v, abt);

      Two_Product(pred, adxtail, bdytail, ti1, ti0);
      Two_Product(pred, bdxtail, adytail, tj1, tj0);
...
double incircle(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd)
{
...
double insphereexact(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd,
                     double *pe)
{
  ...
  Two_Product(pred, pd[0], pe[1], dxey1, dxey0);
  Two_Product(pred, pe[0], pd[1], exdy1, exdy0);
  Two_Two_Diff(dxey1, dxey0, exdy1, exdy0, de[3], de[2], de[1], de[0]);

  Two_Product(pred, pe[0], pa[1], exay1, exay0);
  Two_Product(pred, pa[0], pe[1], axey1, axey0);
  ...
  Two_Product(pred, pc[0], pe[1], cxey1, cxey0);
  Two_Product(pred, pe[0], pc[1], excy1, excy0);
  ...
  Two_Product(pred, pe[0], pb[1], exby1, exby0);
  Two_Product(pred, pb[0], pe[1], bxey1, bxey0);
...
double insphereslow(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd, double *pe)
{
  ...
  Two_Two_Product(pred, aex, aextail, bey, beytail,
                  axby7, axby[6], axby[5], axby[4],
                  axby[3], axby[2], axby[1], axby[0]);
  axby[7] = axby7;
  negate = -aey;
  negatetail = -aeytail;
  Two_Two_Product(pred, bex, bextail, negate, negatetail,
                  bxay7, bxay[6], bxay[5], bxay[4],
                  bxay[3], bxay[2], bxay[1], bxay[0]);
  bxay[7] = bxay7;
  ablen = fast_expansion_sum_zeroelim(8, axby, 8, bxay, ab);
  Two_Two_Product(pred, bex, bextail, cey, ceytail,
                  bxcy7, bxcy[6], bxcy[5], bxcy[4],
                  bxcy[3], bxcy[2], bxcy[1], bxcy[0]);
  bxcy[7] = bxcy7;
  negate = -bey;
  negatetail = -beytail;
  Two_Two_Product(pred, cex, cextail, negate, negatetail,
                  cxby7, cxby[6], cxby[5], cxby[4],
                  cxby[3], cxby[2], cxby[1], cxby[0]);
  cxby[7] = cxby7;
  bclen = fast_expansion_sum_zeroelim(8, bxcy, 8, cxby, bc);
  Two_Two_Product(pred, cex, cextail, dey, deytail,
                  cxdy7, cxdy[6], cxdy[5], cxdy[4],
                  cxdy[3], cxdy[2], cxdy[1], cxdy[0]);
  cxdy[7] = cxdy7;
  negate = -cey;
  negatetail = -ceytail;
  Two_Two_Product(pred, dex, dextail, negate, negatetail,
                  dxcy7, dxcy[6], dxcy[5], dxcy[4],
                  dxcy[3], dxcy[2], dxcy[1], dxcy[0]);
  dxcy[7] = dxcy7;
  cdlen = fast_expansion_sum_zeroelim(8, cxdy, 8, dxcy, cd);
  Two_Two_Product(pred, dex, dextail, aey, aeytail,
                  dxay7, dxay[6], dxay[5], dxay[4],
                  dxay[3], dxay[2], dxay[1], dxay[0]);
  dxay[7] = dxay7;
  negate = -dey;
  negatetail = -deytail;
  Two_Two_Product(pred, aex, aextail, negate, negatetail,
                  axdy7, axdy[6], axdy[5], axdy[4],
                  axdy[3], axdy[2], axdy[1], axdy[0]);
  axdy[7] = axdy7;
  dalen = fast_expansion_sum_zeroelim(8, dxay, 8, axdy, da);
  Two_Two_Product(pred, aex, aextail, cey, ceytail,
                  axcy7, axcy[6], axcy[5], axcy[4],
                  axcy[3], axcy[2], axcy[1], axcy[0]);
  axcy[7] = axcy7;
  negate = -aey;
  ...
  Two_Two_Product(pred, bex, bextail, dey, deytail,
...
double insphereadapt(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd,
                     double *pe, double permanent)
{
  ...
  Two_Product(pred, aex, bey, aexbey1, aexbey0);
  Two_Product(pred, bex, aey, bexaey1, bexaey0);
  Two_Two_Diff(aexbey1, aexbey0, bexaey1, bexaey0, ab3, ab[2], ab[1], ab[0]);
  ab[3] = ab3;

  Two_Product(pred, bex, cey, bexcey1, bexcey0);
  Two_Product(pred, cex, bey, cexbey1, cexbey0);
  Two_Two_Diff(bexcey1, bexcey0, cexbey1, cexbey0, bc3, bc[2], bc[1], bc[0]);
  bc[3] = bc3;

  Two_Product(pred, cex, dey, cexdey1, cexdey0);
  Two_Product(pred, dex, cey, dexcey1, dexcey0);
  Two_Two_Diff(cexdey1, cexdey0, dexcey1, dexcey0, cd3, cd[2], cd[1], cd[0]);
  cd[3] = cd3;

  Two_Product(pred, dex, aey, dexaey1, dexaey0);
  Two_Product(pred, aex, dey, aexdey1, aexdey0);
  Two_Two_Diff(dexaey1, dexaey0, aexdey1, aexdey0, da3, da[2], da[1], da[0]);
  da[3] = da3;

  Two_Product(pred, aex, cey, aexcey1, aexcey0);
  Two_Product(pred, cex, aey, cexaey1, cexaey0);
  Two_Two_Diff(aexcey1, aexcey0, cexaey1, cexaey0, ac3, ac[2], ac[1], ac[0]);
  ac[3] = ac3;

  Two_Product(pred, bex, dey, bexdey1, bexdey0);
  Two_Product(pred, dex, bey, dexbey1, dexbey0);
...
double insphere(predicatesdef *pred, double *pa, double *pb, double *pc, double *pd, double *pe)
{
  double aex, bex, cex, dex;
  double aey, bey, cey, dey;
  double aez, bez, cez, dez;
